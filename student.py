...
class Student:
    def __init__(self, root):
        ...
        title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",30,"bold"),bg="teal",fg="black")
        ...
        current_course_frame.place(x=5,y=95,width=595,height=100)
        ...
        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dep,font=("times new roman",10,"bold"),state="read only",width=15)
        ...
        course_combo=ttk.Combobox(current_course_frame,textvariable=self.var_course,font=("times new roman",10,"bold"),state="read only",width=15)
        ...
        year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_year,font=("times new roman",10,"bold"),state="read only",width=15)
        year_combo["values"]=("Select Year","2020-2021","2021-2022","2022-2023","2023-2024")
        year_combo.current(0)
        year_combo.grid(row=1,column=1,padx=2,pady=10,sticky=W)

        #semester
        semester_label=Label(current_course_frame,textvariable=self.var_year,text="Semester",font=("times new roman",11,"bold"),bg="white")
        semester_label.grid(row=1,column=2,padx=10,sticky=W)
            #,textvariable=self.var_sem
        semester_combo=ttk.Combobox(current_course_frame,textvariable=self.var_sem,font=("times new roman",10,"bold"),state="read only",width=15)
        ...
        Class_Student_frame.place(x=5,y=195,width=595,height=280)
        ...
        studentID_entry=ttk.Entry(Class_Student_frame,textvariable=self.va_std_id,width=20,font=("times new roman",10,"bold"))
        ...
        #class division
        clas_div_label=Label(Class_Student_frame,text="Class Divisions",font=("times new roman",11,"bold"),bg="white")
        clas_div_label.grid(row=1,column=0,padx=10,pady=5,sticky=W)
            #,textvariable=self.var_div
        div_combo=ttk.Combobox(Class_Student_frame,textvariable=self.var_div,font=("times new roman",10,"bold"),state="read only",width=18)
        ...
        cal = DateEntry(Class_Student_frame,textvariable=self.var_DOB, width=20, year=2003, month=7, day=22, 
         background='darkblue', foreground='white', borderwidth=2)
        cal.grid(row=2,column=3,padx=10, pady=10)

        #Email
        Email_label=Label(Class_Student_frame,text="Email ID",font=("times new roman",11,"bold"),bg="white")
        ...
        #Teacher Name
        teacher_name_label=Label(Class_Student_frame,text="Teacher Name",font=("times new roman",11,"bold"),bg="white")
        teacher_name_label.grid(row=4,column=2,padx=10,pady=5,sticky=W)
            #,textvariable=self.var_teacher
        teacher_name_entry=ttk.Entry(Class_Student_frame,textvariable=self.var_teacher,width=20,font=("times new roman",10,"bold"))
        ...
        btn_frame.place(x=0,y=195,width=590,height=27)
            #,command=self.add_data
        save_btn=Button(btn_frame,command=self.add_data,text="Save",width=20,font=("times new romn",9,"bold"),bg="teal",fg="black")
        save_btn.grid(row=0,column=0)
            #
        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=20,font=("times new romn",9,"bold"),bg="teal",fg="black")
        update_btn.grid(row=0,column=1)
            #,command=self.delete_data
        delete_btn=Button(btn_frame,text="Delete",width=20,command=self.delete_data,font=("times new romn",9,"bold"),bg="teal",fg="black")
        delete_btn.grid(row=0,column=2)
            #command=self.reset_data,
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=18,font=("times new romn",9,"bold"),bg="teal",fg="black")
        reset_btn.grid(row=0,column=3)

        btn_frame1=Frame(Class_Student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=0,y=225,width=590,height=27)
            #command=self.generate_dataset
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo",width=36,font=("times new romn",10,"bold"),bg="teal",fg="black")
        take_photo_btn.grid(row=0,column=0)

        Update_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Update Photo",width=35,font=("times new romn",10,"bold"),bg="teal",fg="black")
        ...
        img_right=img_right.resize((600,90),Image.ANTIALIAS)
        ...
        search_frame.place(x=5,y=95,width=595,height=70)
        ...
        search_combo=ttk.Combobox(search_frame,textvariable=self.var_com_search,font=("times new roman",10,"bold"),state="read only",width=15)
        ...
        search_entry=ttk.Entry(search_frame,textvariable=self.var_search,width=15,font=("times new roman",10,"bold"))
        search_entry.grid(row=0,column=2,padx=10,pady=5,sticky=W)
            #command=self.search_data,
        Search_btn=Button(search_frame,command=self.search_data,text="Search",width=12,font=("times new romn",10,"bold"),bg="teal",fg="black")
        Search_btn.grid(row=0,column=3,padx=4)
            #command=self.fetch_data,
        showall_btn=Button(search_frame,command=self.fetch_data,text="Show All",width=12,font=("times new romn",10,"bold"),bg="teal",fg="black")
        showall_btn.grid(row=0,column=4,padx=4)
        
        
        #table frame
        table_frame=Frame(Right_frame,bd=2,bg="white",relief=RIDGE)
        table_frame.place(x=5,y=170,width=595,height=300)
            ...
            try:
                ...
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        cv2.putText(face,str(img_id),(0,0),cv2.FONT_HERSHEY_COMPLEX,2,(0,255,255,0),2)
